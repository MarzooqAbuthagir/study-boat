...
public class videos extends TabActivity {
...
//        fm = getSupportFragmentManager();
        ...
        utilis = new Utilis(videos.this);
//        initToolbar();
        Window window = videos.this.getWindow();
...
// finally change the color
        window.setStatusBarColor(ContextCompat.getColor(videos.this,R.color.video));
...
//        allSubjectAPI();
        ...
        TabHost.TabSpec spec3;            // Reusable TabSpec for each tab
        Intent intents;                   // Reusable Intent for each tab
        Bundle userData;



        intents = new Intent().setClass(this, paidvideos.class);
        userData = new Bundle();

        intents.putExtras(userData);
        spec3 = tabHost.newTabSpec("Paid Videos").setIndicator("Paid Videos").setContent(intents);
        tabHost.addTab(spec3);


        intents = new Intent().setClass(this, freevideos.class);
        userData = new Bundle();

        intents.putExtras(userData);
        spec3 = tabHost.newTabSpec("Free Videos").setIndicator("Free Videos").setContent(intents);
        tabHost.addTab(spec3);
        tabHost.getTabWidget().getChildAt(tabHost.getCurrentTab()).getBackground().setColorFilter(getResources().getColor(R.color.tab_video), PorterDuff.Mode.MULTIPLY);
...
//
//            utilis.showProgress(videos.this);
//
...
//                            }
//
//                            JoinedAdapterlist adapter = new JoinedAdapterlist(videos.this, practicelists);
//
//
...
//                            str_message = obj.getString("Message");
//
//                            Toast.makeText(videos.this, str_message, Toast.LENGTH_SHORT).show();
//
//                        }
//
...
//
//                    utilis.dismissProgress();
//                    Toast.makeText(videos.this, videos.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
//
...
//
//        } else {
//            Toast.makeText(this,videos.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
//        }
//    }
//
//
...
//
//                    Intent intent = new Intent(videos.this, videounitlist.class);
//
//                    // Sending value to another activity using intent.
