...
public class saveanswerevent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saveanswerevent);
        Window window = saveanswerevent.this.getWindow();
...
// finally change the color
        window.setStatusBarColor(ContextCompat.getColor(saveanswerevent.this,R.color.my_statusbar_color1));
        utilis = new Utilis(saveanswerevent.this);
        dbHelper = new DBHelper(saveanswerevent.this);
        getValues();
...
//        System.out.println("timer"+timer);
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println("timer"+timer);
                Intent i=new Intent(saveanswerevent.this,Checkwrongsingle.class);
...
//
                ...
                startActivity(new Intent(saveanswerevent.this, eventpackage.class));
                finish();
...
//                System.out.println("Elements in Array"+objArray[k]);
    ...
    private void submittrsult(final String lastid, final String answer, final String wrong, final String timer) {
        ...
        if (utilis.isAvailInternet() == true) {
            ...
            utilis.showProgress(saveanswerevent.this);
...
deleteTable();
                            ...
                            startActivity(new Intent(saveanswerevent.this, subcription.class));
                            finish();
                            ...
                            Toast.makeText(saveanswerevent.this, str_message, Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    utilis.dismissProgress();
                    Toast.makeText(saveanswerevent.this, saveanswerevent.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, saveanswerevent.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    ...
    private void back() {
        deleteTable();
        startActivity(new Intent(saveanswerevent.this, MainActivity.class));
        finish();
    }
