...
public class Singlequestion extends AppCompatActivity {
  ...
  public static   String TAG = "Question",ID="",IDs="", timer="",time="",isCorrect="NO",isWrong="NO",isSkip="NO",isAll="NO", testName="";
...
String i="1";
  ...
  String butttontext="";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_tests);
        dbHelper = new DBHelper(Singlequestion.this);
        utilis = new Utilis(Singlequestion.this);
        Window window = Singlequestion.this.getWindow();
...
// finally change the color
        window.setStatusBarColor(ContextCompat.getColor(Singlequestion.this,R.color.my_statusbar_color1));
        ...
        Cursor cur = dbHelper.vatbook.rawQuery("select * from " + dbHelper.selctedlist, null);
        System.out.println(" selctedlist count " + cur.getCount());
...
//                        str_itemPrice = cursor.getString(cursor.getColumnIndex("itemPrice"));
//                        str_itemVatAmt = cursor.getString(cursor.getColumnIndex("itemVatAmt"));
                                System.out.println(TAG + " From Db wrong " +""+wrongs+"");
...
//
    ...
    private void submittrsult(final String lastid, final String answer, final String wrong, final String timer) {
        if (utilis.isAvailInternet() == true) {
            ...
            utilis.showProgress(Singlequestion.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, utilis.Api + utilis.submit, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                            ...
                            Toast.makeText(Singlequestion.this, str_message, Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    utilis.dismissProgress();
                    Toast.makeText(Singlequestion.this, Singlequestion.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    System.out.println( "  inputs timer " + timern);
                    return params;
                }
            };
            ...
            Toast.makeText(this, Singlequestion.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    ...
    private void setlist() {
        ...
        if(opt1.length() >10){
            ...
            if (lastFourDigits.equals(".png")){
                ...
                Glide.with(Singlequestion.this).load(opt1).apply(new RequestOptions()
        ...
        if (opt2.length() >10){
            ...
            if (lastFourDigits2.equals(".png")){
                ...
                Glide.with(Singlequestion.this).load(opt2).apply(new RequestOptions()
                        .override(Target.SIZE_ORIGINAL)
                        .format(DecodeFormat.PREFER_ARGB_8888))
                        .skipMemoryCache(true) //2
        ...
        if (opt3.length() > 10){
            ...
            if (lastFourDigits3.equals(".png")){
                ...
                Glide.with(Singlequestion.this).load(opt3).apply(new RequestOptions()
                        .override(Target.SIZE_ORIGINAL)
                        .format(DecodeFormat.PREFER_ARGB_8888))
                        .skipMemoryCache(true) //2
        ...
        if (opt4.length() >10){
            ...
            if (lastFourDigits4.equals(".png")){
                ...
                Glide.with(Singlequestion.this).load(opt4)
      ...
      //  questionm.setDisplayText(Qus);
        ...
        if (firstFourCharscheck.equals("https://")){
            ...
            if (splits0.length==1){
                ...
                Glide.with(Singlequestion.this).load(input1)
                        .apply(new RequestOptions()
                                .override(Target.SIZE_ORIGINAL)
                                .format(DecodeFormat.PREFER_ARGB_8888))
                        .skipMemoryCache(true) //2
            ...
            if (splits0.length==2){
                ...
                if(splits22.length==1){
                    ...
                    Glide.with(Singlequestion.this).load(input01)
                            .apply(new RequestOptions()
                                    .override(Target.SIZE_ORIGINAL)
                                    .format(DecodeFormat.PREFER_ARGB_8888))
                            .skipMemoryCache(true) //2
            ...
            if (splits0.length==3) {
                ...
                if (splits31.length==1){
                    ...
                    if (splits033.startsWith("https")==true){
                        ...
                        Glide.with(Singlequestion.this).load(input3)
                                .apply(new RequestOptions()
                                        .override(Target.SIZE_ORIGINAL)
                                        .format(DecodeFormat.PREFER_ARGB_8888))
                                .skipMemoryCache(true) //2
                        ...
                        Glide.with(Singlequestion.this).load(input21)
                                .apply(new RequestOptions()
                                        .override(Target.SIZE_ORIGINAL)
                                        .format(DecodeFormat.PREFER_ARGB_8888))
                                .skipMemoryCache(true) //2
                        ...
                        Glide.with(Singlequestion.this).load(input212s)
                                .apply(new RequestOptions()
                                        .override(Target.SIZE_ORIGINAL)
                                        .format(DecodeFormat.PREFER_ARGB_8888))
                                .skipMemoryCache(true) //2
...
if (textonly.equals("")){
    ...
    Glide.with(Singlequestion.this).load(input3)
            ...
            .diskCacheStrategy(DiskCacheStrategy.NONE) //3
            .into(qimage3);
    Glide.with(Singlequestion.this).load(input4)
            .apply(new RequestOptions()
                    .override(Target.SIZE_ORIGINAL)
                    .format(DecodeFormat.PREFER_ARGB_8888))
            .skipMemoryCache(true) //2
            ...
            if(splits1.length==3){
                ...
                if (splitstwo1.length==1){
                  ...
                  String  input312 = imageset1.trim();
                    ...
                    Glide.with(Singlequestion.this).load(input312)
                            .apply(new RequestOptions()
                                    .override(Target.SIZE_ORIGINAL)
                                    .format(DecodeFormat.PREFER_ARGB_8888))
                            .skipMemoryCache(true) //2
                ...
                if (splitstwo1.length==2){
                    ...
                    Glide.with(Singlequestion.this).load(input31)
                            .apply(new RequestOptions()
                                    .override(Target.SIZE_ORIGINAL)
                                    .format(DecodeFormat.PREFER_ARGB_8888))
                            .skipMemoryCache(true) //2
...
//                            .into(qimage);
                    ...
                    Glide.with(Singlequestion.this).load(input31)
                            ...
                            .diskCacheStrategy(DiskCacheStrategy.NONE) //3
                            .into(qimage);
                    Glide.with(Singlequestion.this).load(input)
                            .apply(new RequestOptions()
                                    .override(Target.SIZE_ORIGINAL)
                                    .format(DecodeFormat.PREFER_ARGB_8888))
                            .skipMemoryCache(true) //2
...
//    }
    ...
    private void alertshow() {
        ...
        // custom dialog
         dialog = new Dialog(Singlequestion.this);
...
//            }
    ...
    private void back() {
        ...
        Intent intent = new Intent(Singlequestion.this, MainActivity.class); //OrderDetailsActivity
