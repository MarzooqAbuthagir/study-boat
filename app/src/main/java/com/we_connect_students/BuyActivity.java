...
public class BuyActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Window window = BuyActivity.this.getWindow();
...
// finally change the color
        window.setStatusBarColor(ContextCompat.getColor(BuyActivity.this, R.color.voil));
        utilis = new Utilis(BuyActivity.this);
        initToolbar();
        ...
        apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((remove.equals("Apply"))){
                    ...
                    if (referl.equals("")){
                        Toast.makeText(BuyActivity.this, "Enter Referal Code", Toast.LENGTH_SHORT).show();
                    }
                    else{
    ...
    private void apicallamount(final String referl, final String price) {
        ...
        if (utilis.isAvailInternet() == true) {
            ...
            utilis.showProgress(BuyActivity.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, utilis.Api + utilis.check, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                            ...
                            Toast.makeText(BuyActivity.this, str_message, Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    utilis.dismissProgress();
                    Toast.makeText(BuyActivity.this, BuyActivity.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, BuyActivity.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    ...
    private void apicall(final String id, final String nprics, final String referl) {
        ...
        if (utilis.isAvailInternet() == true) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, utilis.Api + utilis.submitpack, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                         ...
                         // utilis.BUYID="1";
                          //  startActivity(new Intent(BuyActivity.this, PackageActivity.class));
                            ...
                            Intent intent = new Intent(BuyActivity.this, ShowWebView.class); //OrderDetailsActivity

                            intent.putExtra("Qcount", BuyActivity.this.id);
...
//        finish();
        ...
        Intent intent = new Intent(BuyActivity.this, PackageActivity.class); //OrderDetailsActivity
