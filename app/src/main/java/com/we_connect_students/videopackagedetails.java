...
import com.we_connect_students.R;
...
public class videopackagedetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videopackagedetails);
        fm = getSupportFragmentManager();

        utilis = new Utilis(videopackagedetails.this);

        Window window = videopackagedetails.this.getWindow();
...
// finally change the color
        window.setStatusBarColor(ContextCompat.getColor(videopackagedetails.this,R.color.packagesd));
...
//        container.setVisibility(View.GONE);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(videopackagedetails.this, videobuynow.class); //OrderDetailsActivity
...
//                startActivity(intent);
    ...
    private void packdetailsapi(final String id) {
        ...
        if (utilis.isAvailInternet() == true) {
            ...
            utilis.showProgress(videopackagedetails.this);

            StringRequest stringRequest = new StringRequest(Request.Method.POST, utilis.Api + utilis.videopackageslist, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (Integer.parseInt(str_result) == 1) {
                            ...
                            Toast.makeText(videopackagedetails.this, str_message, Toast.LENGTH_SHORT).show();
                            container.setVisibility(View.GONE);
...
//                            container.setVisibility(View.VISIBLE);
                            ...
                            for (int i = 0; i < json.length(); i++) {
                                ...
                                Packagesub values = new Packagesub(jsonObject.getString("subjectName"),
                                        jsonObject.getString("questionCount"));

                                packagesub.add(values);
                            }
                            JoinedAdapterlist adapter = new JoinedAdapterlist(videopackagedetails.this, packagesub);
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    utilis.dismissProgress();
                    Toast.makeText(videopackagedetails.this, videopackagedetails.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, videopackagedetails.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    ...
    private void back() {
        ...
        Intent intent = new Intent(videopackagedetails.this, PackageActivity.class); //OrderDetailsActivity
