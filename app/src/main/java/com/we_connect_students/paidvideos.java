...
public class paidvideos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paidvideos);
        fm = getSupportFragmentManager();

        utilis = new Utilis(paidvideos.this);
//        initToolbar();
        Window window = paidvideos.this.getWindow();
...
// finally change the color
        window.setStatusBarColor(ContextCompat.getColor(paidvideos.this,R.color.video));
...
//                Intent i = new Intent(paidvideos.this, MainActivity.class);
//
//
//                startActivity(i);
//            }
...
//        });
    ...
    private void allSubjectAPI() {
        ...
        if (utilis.isAvailInternet() == true) {
            ...
            utilis.showProgress(paidvideos.this);
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                            ...
                            JoinedAdapterlist adapter = new JoinedAdapterlist(paidvideos.this, practicelists);
...
//                            Toast.makeText(paidvideos.this, str_message, Toast.LENGTH_SHORT).show();
                            listView.setVisibility(View.GONE);
                            tvEmpty.setVisibility(View.VISIBLE);
                        }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    utilis.dismissProgress();
                    Toast.makeText(paidvideos.this, paidvideos.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this,paidvideos.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.clicklay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(paidvideos.this, videounitlist.class);
