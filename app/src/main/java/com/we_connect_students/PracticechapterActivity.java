...
public class PracticechapterActivity extends AppCompatActivity {
    ...
    ArrayList<Practicelistthree> practicelistthree = new ArrayList<Practicelistthree>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seconds);
        utilis = new Utilis(PracticechapterActivity.this);
        dbHelper=new DBHelper(PracticechapterActivity.this);
        Window window = PracticechapterActivity.this.getWindow();
...
// finally change the color
        window.setStatusBarColor(ContextCompat.getColor(PracticechapterActivity.this,R.color.voil));
        ...
        Button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(PracticechapterActivity.this, MainActivity.class);
        ...
        allSubjectAPI(Subject,Unit);



    }

    private void allSubjectAPI(final String subject, final String unit) {
        ...
        if (utilis.isAvailInternet() == true) {
            ...
            StringRequest stringRequest
                    = new StringRequest(Request.Method.POST, utilis.Api + utilis.learnsubjectlistchapte, new Response.Listener<String>() {
                @Override
                    ...
                    try {
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                            ...
                            for (int i = 0; i < json.length(); i++) {
                                ...
                                Practicelistthree practicelistthrees = new Practicelistthree(jsonObject.getString("ChapterName"),
                            ...
                            JoinedAdapterlist adapter = new JoinedAdapterlist(PracticechapterActivity.this, practicelistthree);
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    utilis.dismissProgress();
                    Toast.makeText(PracticechapterActivity.this, PracticechapterActivity.this.getResources().getString(R.string.somethingwentwrong), Toast.LENGTH_SHORT).show();
    ...
    private void back() {
        ...
        Intent intent = new Intent(PracticechapterActivity.this, PracticeunitActivity.class);
    ...
    private class JoinedAdapterlist  extends BaseAdapter {
        ...
        ViewHolder holder;
        private List<Practicelistthree> Modellist = null;
        private ArrayList<Practicelistthree> Join_arraylist;

        public JoinedAdapterlist(Context context, List<Practicelistthree> Joinmodellist) {

            mInflater = LayoutInflater.from(context);
            this.Modellist = Joinmodellist;
            this.Join_arraylist = new ArrayList<Practicelistthree>();
        ...
        @Override
        public Practicelistthree getItem(int position) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Practicelistthree item = Modellist.get(position);
            ...
            holder.clicklay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    questionanswerapi(Subject,Unit,chapter);



//                    Intent intent = new Intent(PracticechapterActivity.this, PracticechapterActivity.class);
//
//
//                    // Sending value to another activity using intent.
//                    intent.putExtra("Unit", unit);
                        ...
                        if (Integer.parseInt(str_result) == 0) {
                            ...
                            for (int i = 0; i < json.length(); i++) {
                                ...
                                try {
                                    ...
                                    System.out.println("leran"+ dbHelper.questionanswer
                                            + " (Questoin,Answer,Explains,questionNumber)"
                                            + " VALUES ('" + Question + "','" + Answer + "','" + Explanation + "','" + questionNumber + "')");
...
//timercall();
            ...
            Toast.makeText(this, PracticechapterActivity.this.getResources().getString(R.string.nointernet), Toast.LENGTH_SHORT).show();
        }
    }
}